...
def calcular_promedios(ciudad, nombre_ciudad):
    print(f"\nPromedios de temperatura para {nombre_ciudad}:")
...
while True:
    ...
    if opcion == "1":
        calcular_promedios(temperaturas[0], "Pastaza")
    elif opcion == "2":
        calcular_promedios(temperaturas[1], "Pichincha")
    elif opcion == "3":
        calcular_promedios(temperaturas[2], "Guayaquil")
    elif opcion == "4":
